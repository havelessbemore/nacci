...
import { RevSumEncoding as Encoding } from "./revSumEncoding";
  ...
  describe(Encoding.name, () => {
    ...
    describe("genK", () => {
      ...
      it("should return the correct array for positive K", () => {
        ...
        expect(enc.genK(3)).toEqual(cast([2, 3, 4]));
        expect(enc.genK(4)).toEqual(cast([4, 6, 7, 8]));
        expect(enc.genK(5)).toEqual(cast([8, 12, 14, 15, 16]));
      });
    });
    ...
    describe("genNegK", () => {
      ...
      it("should return the correct array for positive K", () => {
        ...
        expect(enc.genNegK(2)).toEqual(cast([-1, 1]));
        expect(enc.genNegK(3)).toEqual(cast([-1, -1, 1]));
        expect(enc.genNegK(4)).toEqual(cast([-1, -1, -1, 1]));
        expect(enc.genNegK(5)).toEqual(cast([-1, -1, -1, -1, 1]));
      });
    });
    ...
    describe("enc.genOne", () => {
      ...
      test("generates relation matrix of even size", () => {
        ...
        const expected = cast([1, 1, 1, 1]);
        expect(result).toEqual(expected);
      });

      test("generates relation matrix of odd size", () => {
        const result = enc.genOne(3);
        const expected = cast([1, 1, 1]);
        expect(result).toEqual(expected);
      });
    ...
    describe("shift", () => {
      ...
      it("should return a correctly shifted array for valid deltas", () => {
        ...
        expect(enc.shift(A, -1)).toEqual(cast([1, 2, 1]));
